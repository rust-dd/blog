...
var hljs = (function () {
      ...
      ((e) => {
        if (Array.isArray(e.begin)) {
          if (e.skip || e.excludeBegin || e.returnBegin)
            throw (P("skip, excludeBegin, returnBegin not compatible with beginScope: {}"), H);
          if ("object" != typeof e.beginScope || null === e.beginScope) throw (P("beginScope must be object"), H);
      ...
      ((e) => {
        if (Array.isArray(e.end)) {
          if (e.skip || e.excludeEnd || e.returnEnd)
            throw (P("skip, excludeEnd, returnEnd not compatible with endScope: {}"), H);
          if ("object" != typeof e.endScope || null === e.endScope) throw (P("endScope must be object"), H);
    ...
    function b(e, t, i, s) {
      ...
      function c() {
        ...
        for (; n; ) {
          ...
          if (s) {
            const [e, a] = s;
            if ((S.addText(t), (t = ""), (l[i] = (l[i] || 0) + 1), l[i] <= 7 && (A += a), e.startsWith("_"))) t += n[0];
            else {
      ...
      function p(e, n) {
        return (
          ...
          e.beginScope &&
            (e.beginScope._wrap
              ? (S.addKeyword(k, w.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (k = ""))
      ...
      function E(e) {
        ...
        M.endScope && M.endScope._wrap
          ...
          : s.skip
          ? (k += n)
          : (s.returnEnd || s.excludeEnd || (k += n), g(), s.excludeEnd && (k = n));
        do {
      ...
      function N(n, s) {
        ...
        if (((y = s), "begin" === s.type))
          return ((e) => {
            ...
            return (
              t.skip ? (k += n) : (t.excludeBegin && (k += n), g(), t.returnBegin || t.excludeBegin || (k = n)),
              p(t, e),
    ...
    function p(e) {
      ...
      const t = ((e) => {
        ...
        if (t) {
          const n = f(t[1]);
          return (
            n || (K(o.replace("{}", t[1])), K("Falling back to no-highlight mode for this block.", e)),
            n ? t[1] : "no-highlight"
          );
        }
      ...
      Object.assign(e, {
        ...
        registerLanguage: (t, a) => {
          ...
          try {
            ...
            if ((P("Language definition for '{}' could not be registered.".replace("{}", t)), !r)) throw e;
            P(e), (i = l);
          }
          i.name || (i.name = t),
            (n[t] = i),
  ...
  function Ee(e) {
    const n = ge,
      ...
      a = { $pattern: ge, keyword: ue, literal: be, built_in: fe, "variable.language": he },
      i = "\\.([0-9](_?[0-9])*)",
      ...
      o = { className: "subst", begin: "\\$\\{", end: "\\}", keywords: a, contains: [] },
      l = {
        begin: "html`",
        end: "",
      ...
      d = { className: "string", begin: "`", end: "`", contains: [e.BACKSLASH_ESCAPE, o] },
      u = {
        className: "comment",
        variants: [
          e.COMMENT(/\/\*\*(?!\/)/, "\\*/", {
    ...
    const p = [].concat(u, o.contains),
      _ = p.concat([{ begin: /\(/, end: /\)/, keywords: a, contains: ["self"].concat(p) }]),
      h = { className: "params", begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: a, contains: _ },
      f = {
        variants: [
          {
            match: [/class/, /\s+/, n],
    ...
    return {
      ...
      contains: [
              ...
              contains: [
                {
                  ...
                  variants: [
                    ...
                    { begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: a, contains: _ },
                  ],
                },
              ],
            },
        ...
        },
        {
          ...
          returnBegin: !0,
          label: "func.def",
          contains: [h, e.inherit(e.TITLE_MODE, { begin: n, className: "title.function" })],
        },
        { match: /\.\.\./, relevance: 0 },
        v,
        { match: "\\$" + n, relevance: 0 },
        { match: [/\bconstructor(?=\s*\()/], className: { 1: "title.function" }, contains: [h] },
        N,
  ...
  var ze = Object.freeze({
    ...
    grmr_bash: (e) => {
      const n = {},
        t = { begin: /\$\{/, end: /\}/, contains: ["self", { begin: /:-/, contains: [n] }] };
      Object.assign(n, {
        className: "variable",
        variants: [
          {
      ...
      const a = {
        ...
        s = { className: "string", begin: /"/, end: /"/, contains: [e.BACKSLASH_ESCAPE, n, a] };
      a.contains.push(s);
      const r = {
          begin: /\$\(\(/,
          end: /\)\)/,
    ...
    grmr_c: (e) => {
      const n = e.COMMENT("//", "$", { contains: [{ begin: /\\\n/ }] }),
        t = "[a-zA-Z_]\\w*::",
        a = "(decltype\\(auto\\)|" + u(t) + "[a-zA-Z_]\\w*" + u("<[^<>]+>") + ")",
        i = {
          className: "type",
          variants: [
            { begin: "\\b[a-z\\d_]*_t\\b" },
        ...
        b = {
          ...
          keywords: d,
          contains: g.concat([{ begin: /\(/, end: /\)/, keywords: d, contains: g.concat(["self"]), relevance: 0 }]),
          relevance: 0,
        },
        m = {
          begin: "(" + a + "[\\*&\\s]+)+" + c,
    ...
    grmr_cpp: (e) => {
      const n = e.COMMENT("//", "$", {
        ...
        t = "[a-zA-Z_]\\w*::",
        a = "(?!struct)(decltype\\(auto\\)|" + u(t) + "[a-zA-Z_]\\w*" + u("<[^<>]+>") + ")",
        i = {
          className: "type",
          begin: "\\b[a-z\\d_]*_t\\b",
        },
        ...
        _ = {
          ...
          keywords: d,
          contains: p.concat([{ begin: /\(/, end: /\)/, keywords: d, contains: p.concat(["self"]), relevance: 0 }]),
          relevance: 0,
        },
        h = {
          className: "function",
    ...
    grmr_less: (e) => {
      const n = ee(e),
        ...
        l = { $pattern: /[a-z-]+/, keyword: "and or not only", attribute: te.join(" ") },
        c = { begin: "\\(", end: "\\)", contains: s, keywords: l, relevance: 0 };
      s.push(
        e.C_LINE_COMMENT_MODE,
        e.C_BLOCK_COMMENT_MODE,
        r("'"),
        ...
        contains: [
          {
            ...
            contains: [
              ...
              i,
              {
                ...
                contains: [{ className: "meta", begin: /<![a-z]/, end: />/, contains: [a, i, r, s] }],
              },
            ],
          },
          e.COMMENT(/<!--/, /-->/, {
      ...
      const n = { begin: /<\/?[A-Za-z_]/, end: ">", subLanguage: "xml", relevance: 0 },
        t = {
          variants: [
            ...
            { begin: b(/\[.+?\]\(/, /[A-Za-z][A-Za-z0-9+.-]*/, /:\/\/.*?\)/), relevance: 2 },
            { begin: /\[.+?\]\([./?&#].*?\)/, relevance: 1 },
            {
              begin: /\[.*?\]\(.*?\)/,
              relevance: 0,
    ...
    grmr_perl: (e) => {
      ...
      return (a.contains = d), (i.contains = d), { name: "Perl", aliases: ["pl", "pm"], keywords: t, contains: d };
    },
    grmr_php: (e) => {
      const n = { className: "variable", begin: "\\$+[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*(?![A-Za-z0-9])(?![$])" },
        t = {
          className: "meta",
          variants: [
        ...
        s = e.inherit(e.QUOTE_STRING_MODE, { illegal: null, contains: e.QUOTE_STRING_MODE.contains.concat(a) }),
        ...
        o = {
          ...
          variants: [e.inherit(i, { begin: "b'", end: "'" }), e.inherit(s, { begin: 'b"', end: '"' }), s, i, r],
        },
        l = {
          className: "number",
          variants: [
    ...
    grmr_python: (e) => {
      const n = {
        ...
        a = { className: "subst", begin: /\{/, end: /\}/, keywords: n, illegal: /#/ },
        i = { begin: /\{\{/, relevance: 0 },
        s = {
          className: "string",
          contains: [e.BACKSLASH_ESCAPE],
          variants: [
            ...
            { begin: /([fF][rR]|[rR][fF]|[fF])"""/, end: /"""/, contains: [e.BACKSLASH_ESCAPE, t, i, a] },
            ...
            { begin: /([fF][rR]|[rR][fF]|[fF])'/, end: /'/, contains: [e.BACKSLASH_ESCAPE, i, a] },
            { begin: /([fF][rR]|[rR][fF]|[fF])"/, end: /"/, contains: [e.BACKSLASH_ESCAPE, i, a] },
            e.APOS_STRING_MODE,
            e.QUOTE_STRING_MODE,
          ],
      ...
      return (
        (a.contains = [s, l, t]),
        {
          ...
          contains: [
            ...
            c,
            e.HASH_COMMENT_MODE,
            { match: [/def/, /\s+/, E], scope: { 1: "keyword", 3: "title.function" }, contains: [d] },
            {
              variants: [
                {
      ...
      const n = "([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",
        ...
        o = {
          ...
          variants: [
            ...
            {
              begin: b(/<<[-~]?'?/, g(/(\w+)(?=\W)[^\n]*\n(?:[^\n]*\n)*?\s*\1\b/)),
              contains: [e.END_SAME_AS_BEGIN({ begin: /(\w+)/, end: /(\w+)/, contains: [e.BACKSLASH_ESCAPE, r] })],
            },
          ],
        },
        l = "[0-9](_?[0-9])*",
        ...
        d = { className: "params", begin: "\\(", end: "\\)", endsParent: !0, keywords: t },
        u = [
          o,
          {
            className: "class",
    ...
    grmr_scss: (e) => {
      ...
      return {
        ...
        contains: [
          ...
          n.ATTRIBUTE_SELECTOR_MODE,
          { className: "selector-tag", begin: "\\b(" + ne.join("|") + ")\\b", relevance: 0 },
          ...
          { begin: "@(page|font-face)", keywords: { $pattern: i, keyword: "@page @font-face" } },
          {
            ...
            returnBegin: !0,
            keywords: { $pattern: /[a-z-]+/, keyword: "and or not only", attribute: te.join(" ") },
            contains: [
        ...
        contains: [
          {
            begin: m(...s),
            relevance: 0,
            keywords: { $pattern: /[\w\.]+/, keyword: o.concat(s), literal: t, type: a },
          },
          { className: "type", begin: m("double precision", "large object", "with timezone", "without timezone") },
          l,
    ...
    grmr_swift: (e) => {
      const n = { match: /\s+/, relevance: 0 },
        ...
        E = (e = "") => ({ className: "subst", match: b(/\\/, e, /[\t ]*(?:[\r\n]|\r\n)/) }),
        y = (e = "") => ({ className: "subst", label: "interpol", begin: b(/\\/, e, /\(/), end: /\)/ }),
        N = (e = "") => ({ begin: b(e, /"""/), end: b(/"""/, e), contains: [f(e), E(e), y(e)] }),
        w = (e = "") => ({ begin: b(e, /"/), end: b(/"/, e), contains: [f(e), y(e)] }),
        v = { className: "string", variants: [N(), N("#"), N("##"), N("###"), w(), w("#"), w("##"), w("###")] },
        O = {
          match: b(/`/, Ie, /`/),
        },
        M = [
        ...
        x = [
          {
            match: /(@|#)available/,
            className: "keyword",
            starts: { contains: [{ begin: /\(/, end: /\)/, keywords: $e, contains: [...p, h, v] }] },
          },
    ...
    grmr_typescript: (e) => {
      ...
      return (
        ...
        a(i, "use_strict", { className: "meta", relevance: 10, begin: /^\s*['"]use strict['"]/ }),
    ...
    grmr_yaml: (e) => {
      const n = "true false yes no null",
        ...
        r = { begin: /\{/, end: /\}/, contains: [s], illegal: "\\n", relevance: 0 },
        ...
        c = [...l];
      return (
        c.pop(), c.push(i), (s.contains = c), { name: "YAML", case_insensitive: !0, aliases: ["yml"], contains: l }
      );
    },
  });
  const Fe = Y;
